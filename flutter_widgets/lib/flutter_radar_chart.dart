...
class flutter_radar_chart extends StatefulWidget {
  @override
  _flutter_radar_chartState createState() => _flutter_radar_chartState();
}

class _flutter_radar_chartState extends State<flutter_radar_chart> {
  bool darkMode = false;
