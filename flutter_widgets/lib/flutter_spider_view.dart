...
class FlutterSpiderView extends StatefulWidget {
  @override
  _FlutterSpiderViewState createState() => _FlutterSpiderViewState();
}

class _FlutterSpiderViewState extends State<FlutterSpiderView> {
  int edge = 6;
